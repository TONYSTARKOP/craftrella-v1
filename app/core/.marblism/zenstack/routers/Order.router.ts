...
export default function createRouter<Config extends BaseConfig>(router: RouterFactory<Config>, procedure: ProcBuilder<Config>) {
    return router({
        ...
        createMany: procedure.input($Schema.OrderInputSchema.createMany.optional()).mutation(async ({ ctx, input }) => checkMutate(db(ctx).order.createMany(input as any))),
        ...
        deleteMany: procedure.input($Schema.OrderInputSchema.deleteMany.optional()).mutation(async ({ ctx, input }) => checkMutate(db(ctx).order.deleteMany(input as any))),
        ...
        findFirst: procedure.input($Schema.OrderInputSchema.findFirst.optional()).query(({ ctx, input }) => checkRead(db(ctx).order.findFirst(input as any))),

        findMany: procedure.input($Schema.OrderInputSchema.findMany.optional()).query(({ ctx, input }) => checkRead(db(ctx).order.findMany(input as any))),
        ...
        count: procedure.input($Schema.OrderInputSchema.count.optional()).query(({ ctx, input }) => checkRead(db(ctx).order.count(input as any))),
...
export interface ClientType<AppRouter extends AnyRouter, Context = AppRouter['_def']['_config']['$types']['ctx']> {
    ...
    count: {
        ...
        useQuery: <T extends Prisma.OrderCountArgs, TData = 'select' extends keyof T
            ? T['select'] extends true
            ? number
            : Prisma.GetScalarType<T['select'], Prisma.OrderCountAggregateOutputType>
            : number>(
                input?: Prisma.Subset<T, Prisma.OrderCountArgs>,
                ...
                TRPCClientErrorLike<AppRouter>
            >;
        useInfiniteQuery: <T extends Prisma.OrderCountArgs>(
            input?: Omit<Prisma.Subset<T, Prisma.OrderCountArgs>, 'cursor'>,
