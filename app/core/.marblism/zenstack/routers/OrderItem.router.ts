...
export default function createRouter<Config extends BaseConfig>(router: RouterFactory<Config>, procedure: ProcBuilder<Config>) {
    return router({
        ...
        createMany: procedure.input($Schema.OrderItemInputSchema.createMany.optional()).mutation(async ({ ctx, input }) => checkMutate(db(ctx).orderItem.createMany(input as any))),
        ...
        deleteMany: procedure.input($Schema.OrderItemInputSchema.deleteMany.optional()).mutation(async ({ ctx, input }) => checkMutate(db(ctx).orderItem.deleteMany(input as any))),
        ...
        findFirst: procedure.input($Schema.OrderItemInputSchema.findFirst.optional()).query(({ ctx, input }) => checkRead(db(ctx).orderItem.findFirst(input as any))),

        findMany: procedure.input($Schema.OrderItemInputSchema.findMany.optional()).query(({ ctx, input }) => checkRead(db(ctx).orderItem.findMany(input as any))),
        ...
        count: procedure.input($Schema.OrderItemInputSchema.count.optional()).query(({ ctx, input }) => checkRead(db(ctx).orderItem.count(input as any))),
...
export interface ClientType<AppRouter extends AnyRouter, Context = AppRouter['_def']['_config']['$types']['ctx']> {
    ...
    count: {
        ...
        useQuery: <T extends Prisma.OrderItemCountArgs, TData = 'select' extends keyof T
            ? T['select'] extends true
            ? number
            : Prisma.GetScalarType<T['select'], Prisma.OrderItemCountAggregateOutputType>
            : number>(
                input?: Prisma.Subset<T, Prisma.OrderItemCountArgs>,
                ...
                TRPCClientErrorLike<AppRouter>
            >;
        useInfiniteQuery: <T extends Prisma.OrderItemCountArgs>(
            input?: Omit<Prisma.Subset<T, Prisma.OrderItemCountArgs>, 'cursor'>,
